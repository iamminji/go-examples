// Code generated by goyacc -o goyacc_example.go -p Calc goyacc_example.y. DO NOT EDIT.

//line goyacc_example.y:8

package main

import __yyfmt__ "fmt"

//line goyacc_example.y:9
...
//line goyacc_example.y:53
		{
			fmt.Printf("%d\n", CalcDollar[1].val)
		}
	case 4:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line goyacc_example.y:57
		{
			regs[CalcDollar[1].val] = CalcDollar[3].val
		}
	case 5:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line goyacc_example.y:63
		{
			CalcVAL.val = CalcDollar[2].val
		}
	case 6:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line goyacc_example.y:65
		{
			CalcVAL.val = CalcDollar[1].val + CalcDollar[3].val
		}
	case 7:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line goyacc_example.y:67
		{
			CalcVAL.val = CalcDollar[1].val - CalcDollar[3].val
		}
	case 8:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line goyacc_example.y:69
		{
			CalcVAL.val = CalcDollar[1].val * CalcDollar[3].val
		}
	case 9:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line goyacc_example.y:71
		{
			CalcVAL.val = CalcDollar[1].val / CalcDollar[3].val
		}
	case 10:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line goyacc_example.y:73
		{
			CalcVAL.val = CalcDollar[1].val % CalcDollar[3].val
		}
	case 11:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line goyacc_example.y:75
		{
			CalcVAL.val = CalcDollar[1].val & CalcDollar[3].val
		}
	case 12:
		CalcDollar = CalcS[Calcpt-3 : Calcpt+1]
//line goyacc_example.y:77
		{
			CalcVAL.val = CalcDollar[1].val | CalcDollar[3].val
		}
	case 13:
		CalcDollar = CalcS[Calcpt-2 : Calcpt+1]
//line goyacc_example.y:79
		{
			CalcVAL.val = -CalcDollar[2].val
		}
	case 14:
		CalcDollar = CalcS[Calcpt-1 : Calcpt+1]
//line goyacc_example.y:81
		{
			CalcVAL.val = regs[CalcDollar[1].val]
		}
	case 15:
		CalcDollar = CalcS[Calcpt-4 : Calcpt+1]
//line goyacc_example.y:83
		{
			CalcVAL.val = CalcDollar[1].val * 2
		}
	case 17:
		CalcDollar = CalcS[Calcpt-1 : Calcpt+1]
//line goyacc_example.y:88
		{
